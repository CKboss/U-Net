...
import numpy as np
from Xenial.test.UNetPlus.image_util import BaseDataProvider
...
if __name__=='__main__':
    dst = RgbDataProvider(256,256)
    img,label = dst.next_data()
    print(label.shape)
    plt.imshow(to_rgb(img[0]))
    plt.show()
